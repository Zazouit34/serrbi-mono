...
const components: Options['components'] = {
  ol: ({ node, children, className, ...props }) => (
    <ol className={cn('ml-4 list-decimal list-outside', className)} {...props}>
      {children}
    </ol>
  ),
  ...
  ul: ({ node, children, className, ...props }) => (
    <ul className={cn('ml-4 list-disc list-outside', className)} {...props}>
      {children}
    </ul>
  ),
  ...
  a: ({ node, children, className, ...props }) => (
    <a
      className={cn('font-medium underline text-primary', className)}
      rel="noreferrer"
      target="_blank"
      {...props}
    >
  ...
  table: ({ node, children, className, ...props }) => (
    <div className="overflow-x-auto my-4">
      <table
        className={cn('w-full border border-collapse border-border', className)}
        {...props}
      >
        {children}
      </table>
  ...
  th: ({ node, children, className, ...props }) => (
    <th
      className={cn('px-4 py-2 text-sm font-semibold text-left', className)}
      {...props}
    >
      {children}
    </th>
  ...
  blockquote: ({ node, children, className, ...props }) => (
    <blockquote
      className={cn(
        'pl-4 my-4 italic border-l-4 border-muted-foreground/30 text-muted-foreground',
        className
      )}
      {...props}
    >
