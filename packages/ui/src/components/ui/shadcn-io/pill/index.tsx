...
export const PillAvatar = ({
  ...
  <Avatar className={cn('-ml-1 w-4 h-4', className)}>
    <AvatarImage {...props} />
...
export const PillStatus = ({
  ...
  <div
    className={cn(
      'flex gap-2 items-center pr-2 font-medium border-r',
      className
    )}
    {...props}
  >
...
export const PillDelta = ({ className, delta }: PillDeltaProps) => {
  ...
  if (delta > 0) {
    return (
      <ChevronUpIcon className={cn('text-emerald-500 size-3', className)} />
    );
  }

  return <ChevronDownIcon className={cn('text-rose-500 size-3', className)} />;
};
