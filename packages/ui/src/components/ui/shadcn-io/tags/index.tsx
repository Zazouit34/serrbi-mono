...
export const TagsTrigger = ({
  ...
  <PopoverTrigger asChild>
    <Button
      className={cn('justify-between p-2 w-full h-auto', className)}
...
export const TagsValue = ({
  ...
  return (
    <Badge className={cn('flex gap-2 items-center', className)} {...props}>
      {children}
      {onRemove && (
        ...
        <div
          className="cursor-pointer size-auto hover:text-muted-foreground"
...
export const TagsItem = ({ className, ...props }: TagsItemProps) => (
  <CommandItem
    className={cn('justify-between items-center cursor-pointer', className)}
    {...props}
  />
);
