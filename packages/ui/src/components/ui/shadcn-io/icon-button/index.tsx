...
function IconButton({
  ...
  return (
    <motion.button
      ...
      className={cn(
        `inline-flex relative rounded-full cursor-pointer group/icon-button size-10 shrink-0 hover:bg-[var(--icon-button-color)]/10 active:bg-[var(--icon-button-color)]/20 text-[var(--icon-button-color)]`,
        sizes[size],
        className,
      )}
