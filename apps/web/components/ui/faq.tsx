...
import { WarpBackground } from "@workspace/ui/components/ui/shadcn-io/warp-background";
...
export function FAQ() {
  ...
  const faqs: QA[] = (t.raw("items") as { q: string; a: string }[]).map(
    (it) => ({ question: it.q, answer: it.a })
  );
  return (
