...
export function HeroSearchBar() {
  ...
  return (
    ...
    >
      <div className="overflow-hidden bg-white rounded-3xl shadow">
        ...
        {/* Search Content - Ask AI panel + suggestions + results */}
        <div className="px-4 pb-3 md:px-6 md:pb-4">
          <div className="w-full md:w-[600px] mx-auto flex flex-col gap-4">
            {/* Ask AI header */}
            ...
            <div className="flex justify-between items-center px-3 h-12 text-gray-400 bg-gray-100 rounded-2xl">
              <Input
                ...
                className="flex-1 px-0 h-10 text-sm bg-transparent border-none shadow-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              <button
                type="button"
                onClick={() => handleSearch()}
                className="flex justify-center items-center ml-2 text-gray-500 bg-white rounded-xl shadow size-10 hover:bg-gray-50"
              >
                <Search size={18} />
              </button>
            </div>
