...
export function MobileNavbar() {
  ...
  return (
    <nav className="flex fixed right-0 bottom-0 left-0 z-50 justify-around items-center w-full h-14 bg-white shadow-t dark:bg-gray-900 dark:shadow-t-gray-800 md:hidden">
